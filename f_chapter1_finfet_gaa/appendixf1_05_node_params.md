...
| Node | Type | $R_{\mathrm{active}}$ (Ω/□)<br>Diffusion | $R_{\mathrm{gate}}$ (Ω/□)<br>Gate | $R_{\mathrm{contact}}$ (Ω)<br>Contact Chain<br>*(10 contacts)* | $R_{\mathrm{via}}$ (Ω)<br>Via Chain<br>*(5 vias)* | $R_{\mathrm{metal}}$ (Ω/□)<br>Metal |
|------|------|--------------------------------------------|------------------------------------|----------------------------------------------------|----------------------------------------|--------------------------------------|
