...
- **KrF (248nm)** is essential for critical dimensions below ~0.25μm and is standard in 0.18μm processes.
- **i-line (365nm)** is suited for intermediate layers (~0.35μm), balancing cost and resolution.
- **g-line (436nm)** is sufficient for large-feature layers such as pad openings and passivation.

| Exposure Source | Theoretical Resolution (λ/NA) | Use Cases |
|------------------|-------------------------------|------------|
| g-line (436nm) | ~0.5μm | Pad, passivation, non-critical layers |
| i-line (365nm) | ~0.35μm | Wells, Metal-2, interlayer vias |
| KrF (248nm) | ~0.18μm | Poly, S/D, contact, Metal-1 |

---

## 🔗 Related Materials

- [0.18μm Full Process Flow](./0.18um_Logic_ProcessFlow.md)
- [MOS Characteristics and LDD Structure](../../chapter4_mos_characteristics/4.6_LDD_Punchthrough.md)
- [History of Lithography Technology](../appendixf1_01_exposure_history.md)
