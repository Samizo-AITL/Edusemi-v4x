...
| 3 | **G2-OX Thermal Oxidation** | 残ったHV, MV領域に 35Å 酸化膜を形成<br>→ Stack: HV = G1+G2 / MV = G2 |
| 4 | **G2 Remove (HV/MV Mask)** | LV以外からG2を除去（LVのみG2除去）<br>→ Mask: `G2-REMOVE` or `G2-ETCH` |
| 5 | **G3-OX Final Oxidation** | 全領域に35Åを追加形成<br>→ Final stack:<br>HV = 150Å<br>MV = 70Å<br>LV = 35Å |
