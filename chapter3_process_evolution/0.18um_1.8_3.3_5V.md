...
|------|----------------|--------------------|
| 1 | **G1-OX Thermal Oxidation** | 全領域に 70Å の酸化膜（G1）を形成<br>→ Base oxide for HV region (5V) |
| 2 | **G1 Remove (HV Mask)** | HV領域以外（MV, LV）から G1 を選択的に除去<br>→ Mask: `G1-REMOVE` or `G1-ETCH` |
| 3 | **G2-OX Thermal Oxidation** | 全領域に 35Å 酸化膜を形成<br>→ Stack: HV = G1+G2 / MV = G2 / LV=G2|
| 4 | **G2 Remove (HV/MV Mask)** | LVのみG2除去 <br>→ Mask: `G2-REMOVE` or `G2-ETCH` |
| 5 | **G3-OX Final Oxidation** | 全領域に35Åを追加形成<br>→ Final stack:<br>HV = G1+G2+G3=150Å<br>MV =G2+G3= 70Å<br>LV =G3= 35Å |
