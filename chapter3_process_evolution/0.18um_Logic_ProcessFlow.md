...
## 🧩 工程別寸法・露光波長対応表  
### Exposure Conditions by Process Step
...
## 🧠 教育的ポイント / Educational Insight

- **KrF（248nm）** は 0.25μm以下の寸法に対して有効で、0.18μmプロセスでは必須露光源。
- **i-line（365nm）** は中間寸法（〜0.35μm）に対応可能。コストバランスも良い。
- **g-line（436nm）** はPadなどの大寸法向け。レガシー露光装置で対応。

| 光源 | 解像度限界（λ/NA） | 使用範囲 |
|------|---------------------|-----------|
| g-line (436nm) | ~0.5μm | Pad, 保護膜など |
| i-line (365nm) | ~0.35μm | Well, Metal-2など |
| KrF (248nm) | ~0.18μm | ゲート、S/D、コンタクトなど |

---

## 🔗 関連資料 / Related Materials

🔗 詳細な電気特性評価フロー（0.18μm CMOSプロセス）については、補足資料  
👉 [付録：E-TEST工程と測定条件（0.18μm）](../chapter6_test_and_package/appendix_etest_018.md) を参照してください。

- [MOSトランジスタとLDD構造](../chapter4_mos_characteristics/4.6_LDD_Punchthrough.md)
- [露光技術の歴史と限界](../appendixf1_01_exposure_history.md)
