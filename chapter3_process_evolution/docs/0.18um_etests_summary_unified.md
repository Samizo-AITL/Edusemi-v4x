...
> \[
> C_{\text{ox}} = \dfrac{\varepsilon_0 \cdot \varepsilon_{\text{ox}}}{T_{\text{ox}}}
> \]
> where:
...
> Thus:  
> \[
> C_{\text{ox}} \approx \dfrac{8.854 \times 10^{-14} \times 3.9}{T_{\text{ox}}~[\mathrm{cm}]} \approx \dfrac{3.45 \times 10^{-13}}{T_{\text{ox}}~[\mathrm{cm}]}
> \]
>  
> For $T_{\text{ox}} = 3.5\,\mathrm{nm} = 3.5 \times 10^{-7}\,\mathrm{cm}$:  
> \[
> C_{\text{ox}} \approx \dfrac{3.45 \times 10^{-13}}{3.5 \times 10^{-7}} = 9.86 \times 10^{-7}\,\mathrm{F/cm^2}
> \]
> Convert to $\mathrm{fF}/\mu\mathrm{m}^2$ (1 F/cm² = 10 fF/μm²):  
> \[
> C_{\text{ox}} \approx 9.86\,\mathrm{fF}/\mu\mathrm{m}^2
> \]

> 💡 **結果:**  
> $T_{\text{ox}} = 3.5\,\mathrm{nm}$ のとき、  
> $C_{\text{ox}} \approx \mathbf{9.86~\mathrm{fF}/\mu\mathrm{m}^2}$ となります。
