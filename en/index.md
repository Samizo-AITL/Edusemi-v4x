...
| 📦 **Chapter 6**<br>[![View Site](https://img.shields.io/badge/View-Site-brightgreen?logo=github)](https://samizo-aitl.github.io/Edusemi-v4x/f_chapter6_research/)<br>[![View Repo](https://img.shields.io/badge/View-Repo-blue?logo=github)](https://github.com/Samizo-AITL/Edusemi-v4x/tree/main/f_chapter6_research) | Research Paper: SystemDK with AITL | Proposes embedding PID+FSM+LLM control loops into EDA flows to compensate runtime RC delay, thermal coupling, and EMI variations, demonstrating guardband reduction and improved reliability across sub-2nm nodes. |
