...
|---|---|---|
| **RC遅延変動** | 配線スケーリングで **STAが不安定化** | **RC delay variation** destabilizes STA |
| **熱結合** | 3D積層で **温度上昇、P\&R制約逸脱** | **Thermal coupling** from 3D stacking violates P\&R constraints |
| **EMI/EMC変動** | 高速伝送で **ジッタが SI/EMC 解析に影響** | **EMI/EMC variations** induce jitter, affecting SI/EMC analysis |
| **信頼性低下** | **応力や Vth シフト** が PDK 反映困難 | **Stress and Vth shifts** poorly reflected in PDK models |
