...
![断面図](fig/fig1_laminated_cross_section.png)
*図1. 磁性体ラミネーション＋PGS の断面概念図*

![ハイブリッド構成](fig/fig2_buck_ldo_block.png)
*図2. Buck→LDO ハイブリッド電源構成*

![性能サマリ](fig/fig3_performance_table.png)
*図3. Air-core と提案手法の性能比較（目標値）*

![PSRR](fig/fig4_psrr_target.png)
*図4. PSRR の周波数特性（目標の概念図）*

![過渡応答](fig/fig5_transient_response.png)
