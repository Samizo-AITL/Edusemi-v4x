...
| 工程 / Step | 内容（日本語） / *Description (JP)* | 内容（英語） / *Description (EN)* |
|-------------|------------------------------------|-----------------------------------|
| **TI1-SP（下部）** | TiスパッタによるPt密着層（約300Å）。 | Ti sputtering adhesion layer for Pt (~300Å). |
| **Pt-SP** | Pt下部電極（1000–1500Å）、高耐久性・導電性。 | Pt bottom electrode (1000–1500Å), durable and conductive. |
| **PZT-COT / PZT-ANL** | PZTスピンコート＋アニール、ペロブスカイト結晶化。 | PZT spin coating + annealing for perovskite crystallization. |
| **TI2-SP（上部）** | 上部電極、Al配線とのバッファ機能。 | Top electrode, also buffer to Al wiring. |
| **結晶配向確認** | 上部電極形成後、XRDでPZTの(100)/(111)面配向を確認。 | After top electrode, XRD verifies PZT (100)/(111) orientation. |
| **CAP-PH / CAP-ET** | Pt/PZT/Tiパターニング。PtはCMP不可、IBE等の物理エッチ必要。 | Pt/PZT/Ti patterning; CMP not applicable, requires IBE/physical etching. |
...
| 項目 / Item | 日本語解説 / *Description (JP)* | 英語解説 / *Description (EN)* |
|-------------|--------------------------------|-------------------------------|
...
| 評価手法 / Method | 日本語解説 / *Description (JP)* | 英語解説 / *Description (EN)* |
|-------------------|--------------------------------|-------------------------------|
