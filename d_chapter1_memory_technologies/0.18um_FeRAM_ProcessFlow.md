...
- G2-OXは**全面酸化**であり、選択酸化ではありません  
  G2-OX is **global oxidation**, not selective.
- デバイス電圧ごとに**酸化膜厚を調整する高度なインテグレーション技術**  
  Advanced integration for voltage-specific oxide thickness.
