...
![FSM構成図](./images/chapter2_fsm_structure_en_final.png)
...
![FSM状態遷移図](./images/chapter2_fsm_diagram.png)
...
![Moore vs Mealy FSM](./images/chapter2_fsm_moore_mealy.png)
...
| 本節は概念理解が中心、実装は後章で学ぶ | This section focuses on concept; implementation comes later |
