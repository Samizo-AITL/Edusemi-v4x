...
**図X. PN接合ダイオードのI-V特性**  
*Figure X. I-V Characteristics of PN Junction Diode*

左: リニアスケール — 実際の立ち上がりを直感的に理解できる  
*Left: Linear scale — intuitive understanding of exponential rise*  

右: 対数スケール — 飽和電流や逆方向リーク特性を確認できる  
*Right: Log scale — observe saturation current and reverse leakage*  

<img src="./images/diode_iv_linear_log.png" alt="Diode IV" width="80%">
