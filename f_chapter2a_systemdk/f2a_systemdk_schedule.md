...
本資料では、各タスクが **どの成果物をトリガーに開始されるか** を明確にした進行表を示します。  
*This schedule clarifies **which deliverable triggers each task** across the full 28-week plan.*
...
| 週 / Week | 設計部 / *Design* | 制御部 / *Control* | CAD部 / *CAD & Layout* | FAB部 / *Fabrication* | 評価部 / *Evaluation* | 主なトリガー / *Trigger* |
|-----------|------------------|-------------------|------------------------|-----------------------|------------------------|---------------------------|
...
| 23–24 | BR/IP/PKG DK化 <br>*BR/IP/PKG DKization* | | | 2nd試作（Second Silicon） | 再ウエハテスト <br>*Second Wafer Test* | 改善設計完了 |
...
gantt
    ...
    IP再設計・改善 / *IP Redesign & Fix*                  :a8, after e8, 14d   %% 1st Eval 結果トリガー
    ...
    制御系修正 / *Control Fixes*                          :b6, after e8, 14d   %% 1st Eval 結果トリガー
    ...
    ECOレイアウト修正 / *ECO Layout Update*               :c7, after e8, 14d   %% 1st Eval 結果トリガー
    ...
    2nd Silicon準備 / *Second Silicon Prep*               :d4, after a8, 14d   %% 修正版設計トリガー
